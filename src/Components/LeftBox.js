...
function LeftBox() {
  ...
  const peroidStart = usePeriodStart("");
  const peroidEnd = usePeriodEnd("");
      ...
      <div className="leftbox">
        ...
        <div className="menu-box">
          ...
          <div className="menu-box__appoint">
            ...
            <br /> <br />
            (24시 - ex) type 12, 14) <br />
            <input className="time time-start" {...peroidStart} />
            부터 <input className="time time-end" {...peroidEnd} />
            까지
          </div>
